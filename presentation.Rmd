...
<span class = "fragment" data-fragment-index="2">Und dann noch irgendwas mit $C_{\text{max}}$ und $C_{\text{korr}}$ …?</span>
...
<img class = "fragment" data-fragment-index="5" src="img/annoyed_E7iIfUlWHBmh2.gif" />
...
brand$Schaden <- brand$Schaden + floor(rnorm(200, 0, 3))
brand$Fläche  <- brand$Fläche  + floor(rnorm(200, 0, 1))
...
ggplot() +
  geom_point(aes(x = m1$residuals, y = m2$residuals)) +
  geom_smooth(aes(x = m1$residuals, y = m2$residuals), method = "lm", se = F, color = "red") +
