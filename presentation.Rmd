...
>- In R: `pnorm(4.5, mean = 3, sd = 2) - pnorm(2, mean = 3, sd = 2)`
...
t_8 <- sjt.xtab(ngo$abschalt, ngo$jahrgang, 
               show.exp = T, show.row.prc = T, show.col.prc = T, 
               show.legend = T, 
...
<div class = "fragment">
\[\begin{aligned}
\chi^2 &= \sum_{\text{Alle Zellen}} \frac{(f_b - f_b)^2}{f_e} \\
 &= \frac{(57 - 54)^2}{54} + \frac{(53 - 56)^2}{56} + \ldots + \frac{(22 - 22)^2}{22} \\
 &= 0.167 + 0.161 + \ldots + 0 \approx 0.544
\end{aligned}\]
...
a11 %>% 
  ...
  ggplot(aes(x = Zeitpunkt, y = Gewicht, group = ID, color = ID)) +
    geom_line() +
    geom_jitter(width = .05, height = 0, size = 3) +
