...
$$\bar{x} = \frac{1}{n} \sum^n_i x_i \approx `r round(mean(ngo$stunzahl), 3)`$$
...
$$\sum^n_{i=1} (x_i - \bar{x})^2 \approx `r round(var(ngo$stunzahl) * (length(ngo$stunzahl) - 1), 3)`$$
</div>
<div class = "fragment">
**Varianz**

$${S_x}^2 = \frac{1}{n-1} \sum^n_{i=1} (x_i - \bar{x})^2 \approx `r round(var(ngo$stunzahl), 3)`$$
</div>
<div class = "fragment">
**Standardabweichung**

$$S_x = \sqrt{\frac{1}{n-1} \sum^n_{i=1} (x_i - \bar{x})^2} \approx `r round(sd(ngo$stunzahl), 3)`$$
</div>
...
<div class = "fragment">$\bar{x} = `r values$mean` \quad\quad \sigma = `r values$sd`$</div>
<br />
<div class = "fragment">$23 \rightarrow \frac{23 - 29.52}{5.78} \approx -1.13$</div>
<br />
<div class = "fragment">$27 \rightarrow \frac{27 - 29.52}{5.78} \approx -0.44$</div>
<br />
<div class = "fragment">$31 \rightarrow \frac{31 - 29.52}{5.78} \approx 0.26$</div>
<br />
...
$$C = \sqrt{\frac{\chi^2}{\chi^2 + n}} = \sqrt{\frac{0.544}{0.544 + 246}} \approx 0.002$$
...
$$
\begin{aligned}
\tau_a &= \frac{N_c - N_d}{\frac{(n-1) \cdot n}{2}} \\
&= \frac{6168 - 3996}{\frac{249 \cdot 250}{2}} \\
& \ldots \text{NO WAIT!}
\end{aligned}
$$

<div class = "fragment">Was ist das Problem?</span>
...
$$
\begin{aligned}
\tau_c &= \frac{N_c - N_d}{\frac{1}{2} \cdot n^2 \cdot \frac{m-1}{m}} \quad |\ m = min(r-1, c-1) \\
&= \frac{6168 - 3996}{\frac{1}{2} \cdot 250^2 \cdot \frac{3-1}{3}} \\
&\approx \text{NO WAIT!}
\end{aligned}
$$
